...
struct PropertyDefaultDraft: Equatable {
    ...
    func validationMessage(propertyName: String) -> String? {
        ...
        case .enumType(let cases, _):
            ...
            guard let payloadSchema = resolvedCase.payloadSchema else {
                return nil
            }
    ...
    private mutating func activateEditorInputs() {
        switch targetSchema {
        case .primitive:
...
private func propertySchemaDefinition(
